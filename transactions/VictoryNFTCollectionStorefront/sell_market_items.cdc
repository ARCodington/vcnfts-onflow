...
transaction(royaltyAddress: Address, itemIDs: [UInt64], type: UInt8, price: UFix64, startTime: UInt32, endTime: UInt32, targetPrice: UFix64, royaltyFactor: UFix64) {
    ...
    execute {
        let bundleID = self.victoryCollection.borrow()!.createBundle(itemIDs: itemIDs)
